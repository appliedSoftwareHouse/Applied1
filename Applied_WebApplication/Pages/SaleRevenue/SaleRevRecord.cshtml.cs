...
using static Applied_WebApplication.Pages.SaleRevenue.RevSheetModel;

namespace Applied_WebApplication.Pages.SaleRevenue
{
    [Authorize]
    public class SaleRevRecordModel : PageModel
    {
        [BindProperty]
        ...
        {
            return RedirectToPage("RevSheet", routeValues: new { id = BookID });
        }
